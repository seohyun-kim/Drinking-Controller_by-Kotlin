...
class GattServerActivity : Activity() {
     ...
     */
    private val gattServerCallback = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
    ...
    private fun notifyRegisteredDevices(timestamp: Long, adjustReason: Byte) {
        ...
        for (device in registeredDevices) {
            val timeCharacteristic = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
                bluetoothGattServer
